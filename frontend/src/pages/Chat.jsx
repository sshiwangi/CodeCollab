...
import newImg from "../Images/user-03.png";
const Discussions = () => {
  //   const { user } = ChatState();
  const [fetchAgain, setFetchAgain] = useState(false);
  return (
    <DefaultLayout>
      <Breadcrumb pageName="discussion" />
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div className="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
          <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:flex">
            <div className="hidden h-full flex-col xl:flex xl:w-1/4">
              <div className="sticky border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                <h3 className="text-lg font-medium text-black dark:text-white 2xl:text-xl">
                  ...
                  <span className="rounded-md border-[.5px] border-stroke bg-gray-2 py-0.5 px-2 text-base font-medium text-black dark:border-strokedark dark:bg-boxdark2 dark:text-white 2xl:ml-4">
                    7
                  </span>
                </h3>
              </div>
              <div className="flex max-h-full flex-col overflow-auto p-5">
                <form className="sticky mb-7">
                  <input
                    type="text"
                    className="w-full rounded border border-stroke bg-gray-2 py-2.5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark2"
                    placeholder="Search...."
                    fdprocessedid="do1omh"
                  ></input>
                  <button
                    className="absolute top-1/2 right-4 -translate-y-1/2"
                    fdprocessedid="2i8trn"
                  >
                    <svg
                      width="18"
                      height="18"
            ...
            <div className="fflex h-full flex-col border-l border-stroke dark:border-strokedark xl:w-3/4">
                ...
                <div>
                  <div className="relative-flex">
                    <button
                      ...
                      fdprocessedid="m3vbcf"
                    ></button>
                    <div className="aabsolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark hidden">
                      ...
                      <button className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
                        ...
                        >
                          <path
                            ...
                            fill
                          ></path>
                          <path d="M8.00005 8.1001C7.70005 8.1001 7.42505 8.3501 7.42505 8.6751V11.8501C7.42505 12.1501 7.67505 12.4251 8.00005 12.4251C8.30005 12.4251 8.57505 12.1751 8.57505 11.8501V8.6751C8.57505 8.3501 8.30005 8.1001 8.00005 8.1001Z"></path>
                          <path
              ...
              <div className="no-scrollbar max-h-full space-y-3.5 overflow-auto px-6 py-7.5">
                <div className="max-w-125">
                  ...
                  <div className="mb-2.5 rounded-2xl rounded-tl-none bg-gray py-3 px-5 dark:bg-boxdark2">
                    <p>
                ...
                <form className="flex items-center justify-between space-x-4.5">
                  <div className="relative w-full">
                    <input
                      ...
                      className="h-13 w-full rounded-md border border-stroke bg-gray pl-5 pr-19 text-black placeholder-body outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark2 dark:text-white"
                      fdprocessedid="yyn6wa"
                    />
                    <div className="absolute right-5 top-1/2 inline-flex -translate-y-1/2 items-center justify-end space-x-4">
                      <button
                        className="hover:text-primary"
                        fdprocessedid="zfpjqh"
                      >
                        <svg
                          width="18"
                          height="18"
